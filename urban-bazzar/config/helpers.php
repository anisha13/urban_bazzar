...
function showMsg($msg,$type)
{
	...
	{
		$_SESSION['showmsg'] = '<div class="alert alert-block alert-danger"><button type="button" class="close" data-dismiss="alert"><i class="icon-remove"></i>
			</button><i class="icon-ok red"></i>Error !!! '.$msg.'</div>';
