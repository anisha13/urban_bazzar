<?php include 'layouts/header.php';
 ...
 {
  $_POST['product_photo'] = uploadFile('uploads',$_FILES['product_photo']);
  if(insertItem($conn,$_POST,$_POST['product_photo']))
  {
    showMsg('Item Created Successfully.','success');
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             Add Item <?php if(isset($_SESSION['showmsg'])) echo $_SESSION['showmsg']; unset($_SESSION['showmsg']);  ?>
                          </header>
  ...
  <!-- container section end -->
    ...
    <script type="text/javascript">
        ...
        if(!number.test(product_price))
         ...
         if(!number.test(product_quantity))
            {
               $("#product_quantity").css({"border": "1px solid red"});
               $('#product_quantity').focus();
               setTimeout(function() 
               {
                   $('#product_quantity').css({"border": "1px solid #ddd"});
                }, 5000);
            return false;
        }
