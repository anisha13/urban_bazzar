...
$infoId = $_GET['ref'];
$info = getCategoryById($conn,$infoId);
 ...
 <!--sidebar start-->
      ...
      <section id="main-content">
          ...
          <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">Update category
                          </header>
                          <div class="panel-body">
                              <form class="form-horizontal" method="POST" id="adminform" enctype="multipart/form-data">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" id="category_name" name="category_name" value="<?php echo $info['category_name']; ?>">
                                      </div>
                                  </div>
