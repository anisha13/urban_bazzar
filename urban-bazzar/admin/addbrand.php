...
{
          if(insertBrand($conn,$_POST))
            {
              showMsg('Brand Added Successfully.','success');
              redirection('manageBrand.php');
            } 
            else
              showMsg('Brand already exist.','fail');
        }
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             Add Brand <?php if(isset($_SESSION['showmsg'])) echo $_SESSION['showmsg']; unset($_SESSION['showmsg']);  ?>
                          </header>
