...
$infoId = $_GET['ref'];
$info = getBrandById($conn,$infoId);

if(isset($_POST['savebtn']))
{
      if(updateBrand($conn,$_POST))
        {
          showMsg('Brand Updatedd Successfully.','success');
 ...
 <!--sidebar start-->
      ...
      <section id="main-content">
          ...
          <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">Update Brand
                          </header>
                          <div class="panel-body">
                              <form class="form-horizontal" method="POST" id="adminform" enctype="multipart/form-data">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" id="brand_name" name="brand_name" value="<?php echo $info['brand_name']; ?>">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-sm-2 control-label">
                                  	<input type="hidden" name="id" value="<?php  echo $info['brand_id']; ?>">
  ...
  <!-- container section end -->
    ...
    <script type="text/javascript">
        $('#adminform').submit(function()
        {
            ...
            if(!alpha.test(brand_name))
            {
               $("#brand_name").css({"border": "1px solid red"});
               $('#brand_name').focus();
               setTimeout(function() 
               {
                   $('#brand_name').css({"border": "1px solid #ddd"});
                }, 5000);
            return false;
          }
