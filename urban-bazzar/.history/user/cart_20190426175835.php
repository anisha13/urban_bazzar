			...
			<form method="POST">
					...
					<div class="wrap-table-shopping-cart bgwhite">
						<table class="table-shopping-cart">
							...
							<tr class="table-row">
								...
								<td style="color:red;padding-right:60px"><a onclick="return confirm('Are you sure to delete ?')" href="removecart.php?ref=<?php echo $info['product_id']; ?>"><i class="far fa-trash-alt"></i></a></td>
							</tr>
							<?php endforeach; ?>
						</table>
					</div>
				...
				<div class="bo9 w-size18 p-l-40 p-r-40 p-t-30 p-b-38 m-t-30 m-r-0 m-l-auto p-lr-15-sm">
					...
					<div class="size15 trans-0-4">
						<!-- Button -->
						<button id="checkout" class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" name="orderbtn">
							Proceed to Checkout
						</button>
					</div>
				</div>
...
<!--===============================================================================================-->
	...
	<script>
			...
			// if (document.getElementById("total").value==" " || document.getElementById("total").value==null)
			// {
