				...
				<div class="wrap-table-shopping-cart bgwhite">
					<table class="table-shopping-cart">
						...
						<tr class="table-row">
							...
							<td style="color:red;padding-right:60px"><a onclick="return confirm('Are you sure to delete ?')" href="deleteuser.php?ref=<?php echo $info['product_id']; ?>"><i class="far fa-trash-alt"></i></a></td>
						</tr>
						<?php endforeach; ?>
					</table>
				</div>
