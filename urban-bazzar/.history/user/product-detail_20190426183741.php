			...
			<div class="w-size14 p-t-30 respon5">
				...
				<form method="POST" enctype="multipart/form-data">				
					<div class="flex-w bo5 of-hidden w-size17">
						...
						<input class="size8 m-text18 t-center num-product" type="number" id="second" name="amount" value="">
						<button class="btn-num-product-up color1 flex-c-m size7 bg8 eff2" id="plus">
...
<!--===============================================================================================-->
	...
	<script type="text/javascript">
		...
		if(document.getElementById("second").value == document.getElementById("check").value)
		{
