				...
				<div class="wrap-table-shopping-cart bgwhite">
					<table class="table-shopping-cart">
						...
						<tr class="table-row">
							...
							<td style="color:red;padding-right:60px"><button onclick="return confirm('Are you sure to delete ?')" href="deleteuser.php?ref=<?php echo $info['id']; ?>"><i class="far fa-trash-alt"></i></button></td>
						</tr>
						<?php endforeach; ?>
					</table>
				</div>
